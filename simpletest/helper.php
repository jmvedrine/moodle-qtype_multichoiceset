...
/**
 * Test helper code for the all or nothing multiple response question type.
 *
...
/**
 * Test helper class for the all or nothing multiple response question type.
 *
 * @copyright  2010 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multichoiceset_test_helper {
     ...
     */
    public static function make_an_multichoiceset_two_of_four() {
        question_bank::load_question_definition_classes('multichoiceset');
        $mc = new qtype_multichoiceset_question();

        test_question_maker::initialise_a_question($mc);

        $mc->name = 'All or nothing multiple response question';
        ...
        $mc->correctfeedback = test_question_maker::STANDARD_OVERALL_CORRECT_FEEDBACK;
        $mc->correctfeedbackformat = FORMAT_HTML;
        $mc->shownumcorrect = true;
        $mc->incorrectfeedback = test_question_maker::STANDARD_OVERALL_INCORRECT_FEEDBACK;
        ...
        $mc->hints = array(
            new qtype_multichoiceset_hint(1, 'Hint 1.', FORMAT_HTML, true, false, false),
            new qtype_multichoiceset_hint(2, 'Hint 2.', FORMAT_HTML, true, true, true),
        );
     ...
     * the question returned by {@link make_an_multichoiceset_two_of_four()}.
     * @return object
     */
    public static function get_question_data() {
        ...
        $qdata->name = 'All or nothing multiple response question';
     ...
     * @return qtype_multichoiceset_question
     */
    public static function make_an_multichoiceset_two_of_five() {
        question_bank::load_question_definition_classes('multichoiceset');
        $mc = new qtype_multichoiceset_question();

        test_question_maker::initialise_a_question($mc);

        $mc->name = 'All or nothing multiple response three of five';
        ...
        $mc->hints = array(
            1 => new qtype_multichoiceset_hint(1, 'Hint 1.', FORMAT_HTML, true, false, false),
            2 => new qtype_multichoiceset_hint(2, 'Hint 2.', FORMAT_HTML, true, true, true),
        );
